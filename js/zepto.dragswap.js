        ...
        if (/^(toArray|toJSON)$/.test(method)) {
            if (method == 'toArray') {
                ...
                $(this).find(settings.element).each(function (index, elem) {
                    ...
                    y++;
                    items[index] = {
                        id: $(this).find("#id")[0].textContent
//                                x: x,
//                        y: y,
//                        observacao: $(this).find("#observacao")[0].textContent,
//                        objeto: $(this).find("#objeto")[0].textContent,
//                        data_criacao: $(this).find("#data_criacao")[0].textContent,
//                        data: $(this).find("#data")[0].textContent,
//                        usuario: $(this).find("#usuario")[0].textContent,
//                        lotacao: $(this).find("#lotacao")[0].textContent
                    };
                });
